      ...
      <div class="well well-lg">
        ...
        <form class="form-horizontal" role="form" method="POST" action="<?= site_url('barang/update_barang') ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="jenis_barang" type="text" class="validate" name="jenis_barang" value="<?php echo set_value('jenis_barang'); ?>">
            </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="tgl_keluar" type="date" class="validate" name="tgl_keluar" value="<?php echo set_value('tgl_keluar'); ?>">
            </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="keterangan" type="text" class="validate" name="keterangan" value="<?php echo set_value('keterangan'); ?>">
            </div>
          </div>
